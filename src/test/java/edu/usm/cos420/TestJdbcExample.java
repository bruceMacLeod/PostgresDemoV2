 ...
 *   unit tests on the databases. Number of ways to do this. In the 
 *   code below, we do operations on a different table name (_nurses)
 *   that is defined in the test properties.
 */
